...
namespace DBRepository.Migrations
{
    ...
    [Migration("20181126063108_addDimentionTable")]
    partial class addDimentionTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Models.DataModels.Dimension", b =>
                {
                    ...
                    b.HasIndex("DimensionTableId");

                    b.ToTable("Dimensions");
                });

            modelBuilder.Entity("Models.Models.DataModels.DimensionTable", b =>
                {
                    b.Property<int>("DimensionTableId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<string>("DimensionTableName");

                    b.HasKey("DimensionTableId");

                    b.ToTable("DimensionTables");
                });
            ...
            modelBuilder.Entity("Models.Models.DataModels.Dimension", b =>
                {
                    b.HasOne("Models.Models.DataModels.DimensionTable", "DimensionTable")
                        .WithMany()
                        .HasForeignKey("DimensionTableId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
